...
function createTableGroups(){
	...
	db.run(`Create table if not exists Contacts_Group (id INTEGER PRIMARY KEY AUTOINCREMENT, id_contact INTEGER, id_group, FOREIGN KEY (id_contact) REFERENCES Contacts(id),
		FOREIGN KEY (id_group) REFERENCES Groups(id))`, (err) =>{
			console.log('berhasil dibuat')
		})
